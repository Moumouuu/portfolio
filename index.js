...
function loader() {
    ...
    var w = 0,
        t = setInterval(function () {
            ...
            pourcentage.textContent = w + '%';
            if (w === 100) {
                clearInterval(t);
                w = 0;
            }
            if (pourcentage.textContent == "100%") {
...
function translateWorks() {
    ...
    works_right.style.transform = "translateX(" + window.pageYOffset / -300 + "%)";
}
function translateContact() {
    ...
    contact_left.style.transform = "translateX(" + window.pageYOffset / 150 + "%)";
    contact_right.style.transform = "translateX(" + window.pageYOffset / -300 + "%)";
}
